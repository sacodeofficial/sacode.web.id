              ...
              <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10 lg:mb-14">
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/1.jpeg') }}" alt="Image Description">
                  </div>
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/2.jpeg') }}" alt="Image Description">
                  </div>
                  <div class="p-4 md:p-5">
                    <p class="mt-2 text-xs uppercase text-gray-600 dark:text-neutral-400">
                      Bahasa Pemrograman
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/3.jpeg') }}" alt="Image Description">
                  </div>
                  <div class="p-4 md:p-5">
                    <p class="mt-2 text-xs uppercase text-gray-600 dark:text-neutral-400">
                      Code Editor
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/4.jpeg') }}" alt="Image Description">
                  </div>
                  <div class="p-4 md:p-5">
                    <p class="mt-2 text-xs uppercase text-gray-600 dark:text-neutral-400">
                      Penyedia Librari Icon
                    </p>
                    <h3 class="mt-2 text-lg font-medium text-gray-800 group-hover:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white">
                      6 Penyedia Librari Icon
                    </h3>
                  </div>
                </a>
                <!-- End Card -->
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/5.jpeg') }}" alt="Image Description">
                  </div>
                  <div class="p-4 md:p-5">
                    <p class="mt-2 text-xs uppercase text-gray-600 dark:text-neutral-400">
                ...
                <a class="group flex flex-col bg-white border shadow-sm hover:shadow-md transition dark:bg-neutral-900 dark:border-neutral-800" href="#">
                  <div class="aspect-w-16 aspect-h-9">
                    <img class="w-full object-cover" src="{{ asset('blog/6.jpeg') }}" alt="Image Description">
                  </div>
                  <div class="p-4 md:p-5">
                    <p class="mt-2 text-xs uppercase text-gray-600 dark:text-neutral-400">
                      Penyedia Hosting Indonesia
                    </p>
                    <h3 class="mt-2 text-lg font-medium text-gray-800 group-hover:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white">
                      6 Penyedia Hosting Indonesia
                    </h3>
                  </div>
                </a>
                <!-- End Card -->
