                            ...
                            <div class="py-5">
                                <div class="flex space-x-1">
                                    <div class="text-lg text-gray-800 dark:text-neutral-400">
                                        Want to share in the community be part of our community? 

                                        <div class="flex items-center gap-4 text-white/80">
                                            <a href="#be-a-speaker" class="text-blue-600 hover:underline font-bold">Be a speaker</a> or <a href="#be-a-moderator" class="text-blue-600 hover:underline font-bold">Modeartor</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
